        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="profile.php" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        <label for="campus" class="block mb-2 text-sm font-medium text-gray-600">Change Campus</label>
                        <input type="text" name="campus" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="New Campus">
                    </div>
                    <div>
                        <label for="password" class="block mb-2 text-sm font-medium text-green-600">Enter Your Password to confirm</label>
