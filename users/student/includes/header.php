    ...
    <div class=" md:grid grid-cols-12 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl my-10 px-2">
        <div id="menu" class="hidden md:block bg-white/10 col-span-3 rounded-lg p-4 ">
            ...
            <div id="menu" class="flex flex-col space-y-2 my-5">
                ...
                <?php $booked= selectOne('booking',['student'=>$user['id'],'status'=>1]);?>
                <?php if (!($booked)):?>
                    ...
                    <a href="hostels.php" class="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                        <div class="relative flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                            ...
                            <p class="text-slate-400 text-sm hidden md:block">Book Hostel</p>
                            </div>
                ...
                <a href="history.php" class="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                    <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        ...
                        <div>
                            <p class="font-bold text-base lg:text-lg text-slate-200 leading-4 group-hover:text-indigo-400">Last Activity</p>
                        </div>
        ...
        <div class="fixed w-full z-50 top-0 left-0 bg-gray-800 md:hidden">
            ...
            <div id="mobileMenu" class="hidden md:hidden">
                <div class="flex flex-col space-y-4 px-4 py-2">
                    <a href="profile.php" class="flex space-y-2 md:space-y-0 md:flex-row mb-5 items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
                        <div>
                            <?php if($user['image'] == ""):?>
                    ...
                    <div id="menu" class="flex flex-col space-y-2 my-5">
                        ...
                        <a href="users.php" class="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                            <div class="flex space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                                ...
                                <div>
                                    <p class="font-bold text-base lg:text-lg text-slate-200 leading-4 group-hover:text-indigo-400">Requests</p>
                                </div>
