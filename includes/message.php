<?php if(isset($_SESSION['message'])): ?>
    <div class="fixed top-12 left-0 right-0 z-50 flex flex-col items-center" id="toast-danger">
        <div id="toast-success" class="flex items-center w-full max-w-xs p-4 mb-4 text-white bg-blue-600 rounded-lg shadow" role="alert">
            <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-green-500 bg-green-100 rounded-lg">
                <svg class="w-5 h-5 text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
