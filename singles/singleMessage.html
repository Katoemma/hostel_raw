    ...
    <div class=" md:grid grid-cols-12 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl my-10 px-2">
        ...
        <div id="content" class="bg-white/10 col-span-9 rounded-lg p-6">
            <div>
                ...
                <div class="bg-gray-900 rounded-lg shadow-md w-full ">
                    <div class="flex justify-between items-center px-6 py-4 rounded-t-lg">
                      <h2 class="text-gray-200 text-xl font-bold">Inbox</h2>
                      <button class="text-gray-200 hover:text-gray-800">
                    ...
                    <div class="px-6 py-4">
                      <div class="flex items-center space-x-4 mb-4">
                        <img class="w-12 h-12 rounded-full p-1" src="Screenshot 2023-07-01 195602.png" alt="Profile Image">
                        <div>
                          <h3 class="text-white text-lg font-bold">Mandela Hostel Admin</h3>
                        </div>
                      </div>
                      <div class="space-y-4">
                        <div class="flex items-start space-x-4">
                          ...
                          <div class="bg-gray-200 rounded-lg p-4">
                            <p class="text-black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla fermentum bibendum tellus, vitae euismod eros consequat id.</p>
                            <p class="text-sm text-gray-500 mt-2">8:30 AM</p>
                          </div>
                        </div>
                        <div class="flex items-start space-x-4 flex-row-reverse">
                          <img class="w-12 h-12 rounded-full p-1" src="https://res.cloudinary.com/highereducation/image/upload/f_auto,fl_lossy,q_auto/c_fill,f_auto,fl_lossy,q_auto:best,w_600,h_512,g_face/v1602208628/TheBestSchools.org/hero-images/scholarships-african-american-black-students-hero.jpg" alt="Profile Image">
                          <div class="bg-blue-500 text-white rounded-lg p-4">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            <p class="text-sm mt-2">8:35 AM</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="px-6 py-4 rounded-b-lg">
                      <hr class="border-1 border-gray-200 rounded-full mb-4">
                      <div class="flex items-center space-x-4">
                        <input class="w-full rounded-full px-4 py-2 bg-white focus:outline-none" type="text" placeholder="Type a message...">
