...
<?php include 'includes/header.php' ?>
        ...
        <div id="content" class="bg-white/10 col-span-9 rounded-lg p-6">
            <div id="24h">
                ...
                <div id="stats" class="grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-black/60 p-6 rounded-lg">
                        <div class="flex flex-row space-x-4 items-center">
                            <div>
                                <p class="text-blue-300 text-sm font-medium uppercase leading-4">Students</p>
                                <p class="text-white font-bold text-xl inline-flex items-center space-x-2">
                                    <span>74</span>
                                </p>
                            </div>
            ...
            <!-- start of activity -->
            <div id="last-incomes">
                <h1 class="font-bold py-4 uppercase">Activties</h1>
                <div class="overflow-x-auto">
                    <table class="w-full whitespace-nowrap">
                        <thead class="bg-black/60">
                            <th class="text-left py-3 px-2 rounded-l-lg">Name</th>
                            <th class="text-left py-3 px-2">Room No</th>
